...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$add->bind_param("sdsssssssssssssss", $unique_num, $balance, $rfid, $qr_code, $date, $role, $image, $email, $username, $password, $fname, $mname, $lname, $contact, $address, $status, $deletable);

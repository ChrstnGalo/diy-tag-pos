...
<body>
    <div class="center">
        <div class="lock">
            <div>
                <label style="color: black; margin-bottom:30px">Please Enter your pincode</label>
            </div>
            ...
            <div class="keys">
                ...
                <button type="submit" class="icon next"> <!-- Changed from button to submit -->
            ...
            keys.forEach((key) => {
                key.addEventListener("click", (e) => {
                    if (e.target.closest(".clear")) {
                        ...
                        // Validate PIN before submitting the form
                        ...
                        // I-check muna kung 6 digits na bago idagdag
                        if (input.value.length < 6) {

...
<div class="container-fluid border col-lg-5 col-md-6 mt-5 p-4">
	...
	<form method="post">
		...
		<div class="mb-3">
			...
			<input value="<?= set_value('rfid') ?>" name="rfid" type="text" class="form-control  <?= !empty($errors['rfid']) ? 'border-danger' : '' ?>" id="exampleFormControlInput1" placeholder="Exp: 000123584">
